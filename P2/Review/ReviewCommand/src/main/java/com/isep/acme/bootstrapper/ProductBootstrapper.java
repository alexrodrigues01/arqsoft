...
public class ProductBootstrapper implements CommandLineRunner, Ordered {
    ...
    @Autowired
    public void setProductRepo(@Value("${product.repo}") String userBean, ApplicationContext applicationContext){
        pRepo = (ProductRepository) applicationContext.getBean(userBean);
    }
