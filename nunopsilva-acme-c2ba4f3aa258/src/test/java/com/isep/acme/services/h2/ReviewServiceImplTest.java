...
class ReviewServiceImplTest {
    ...
    void testAddVoteToReview() {
        // Mock behavior of ReviewRepository
        Long reviewID = 1L;
        Review review = new Review("Review text", LocalDate.now(), new Product("123", "Product Name", "Product Description"), "Fun Fact", new Rating(4.5), new User("username","password"));
