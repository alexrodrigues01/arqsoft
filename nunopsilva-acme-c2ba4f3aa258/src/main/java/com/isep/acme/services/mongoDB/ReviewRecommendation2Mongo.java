...
@Service("ReviewRecommendation2Mongo")
public class ReviewRecommendation2Mongo implements ReviewRecommendation {
    ...
    public List<Review> getReviewsRecommended(Long userId) {
        Iterable<ReviewMongo> iterableMongo = repository.findAll();
        Iterable<Review> iterable= reviewMapperAbstract.toReviewListFromMongo(iterableMongo);
